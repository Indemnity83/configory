...
- **Getting Started**
  ...
  - [Recommended Mod Structure](getting-started/recommended-structure.md)

- **The Basics**

  - [Configuration Paths](the-basics/configuration-paths.md)
  - [Defining Values](the-basics/defining-values.md)
  - [Reading Values](the-basics/reading-values.md)
  - [Writing &amp; Saving](the-basics/writing-and-saving.md)
  - [Reloading](the-basics/reloading.md)

- **Digging Deeper**

  - [Validation](digging-deeper/validation.md)
  - [Cross-Value Validation](digging-deeper/cross-value-validation.md)
  - [Descriptions &amp; Introspection](digging-deeper/descriptions-and-introspection.md)
  ...
  - [Generated Commands](digging-deeper/generated-commands.md)
  - [Multiloader Integration](digging-deeper/multiloader-integration.md)

- **Reference**

  - [API Summary](reference/api-summary.md)
  - [Design Goals &amp; Roadmap](reference/design-goals.md)
